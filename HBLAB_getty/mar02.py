...
def extract_vid(vidcap, frame_rate, start_frame, end_frame, fps_str, path_out, filename, txt_log):
    ...
    #                 if count_jum >= 3:
    #                     count_jum = 0
    #                     curent_frame = int(count_frame/frame_rate) + frame_rate
    #                     count_frame = curent_frame - 1
    #             count_frame += 1
    #             if count_frame > end_frame:
    #                 vidcap.release()
    #                 print("FINISHED")
...
if __name__=="__main__":
    ...
    input_loc = r"D:\Sample\2_FPS"
    output_loc = r"D:\Sample\2_FPS"
